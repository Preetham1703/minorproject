...
$sql = "SELECT name, category, city, address, event_date, proof_of_conduction FROM events WHERE email = ?";
...
<head>
    ...
    <style>
        ...
        #title { 
            margin-top:5px; padding: 15px; text-align: center; background: linear-gradient(135deg, #4a90e2, #007aff); color: white; border-radius: 10px; }
        #mainbar {
            margin-top: 3px;
            width: 100%;
            height: auto;
...
<div class="events-container">
    ...
    <div class="events-section" style="height:60vh;overflow-y:auto;">
